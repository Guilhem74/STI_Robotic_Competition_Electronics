...
float SPACING_WHEELS=288,SPACING_WHEELS_CACHE=288;
float FINAL_BOOL_DISTANCE_MM=40,FINAL_BOOL_DISTANCE_MM_CACHE=40;
/*Speed and acceleration profile*/
int16_t SPEED_MAX_DISTANCE_MM_S=250,SPEED_MAX_DISTANCE_MM_S_CACHE=250;
int16_t ACCELERATION_MAX_DISTANCE_MM_S2=100,ACCELERATION_MAX_DISTANCE_MM_S2_CACHE=100;
int16_t BRAKING_MAX_DISTANCE_MM_S2=2,BRAKING_MAX_DISTANCE_MM_S2_CACHE=2;
