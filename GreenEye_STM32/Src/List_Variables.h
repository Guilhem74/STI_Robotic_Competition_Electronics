...
int16_t SPEED_MAX_DISTANCE_MM_S=500,SPEED_MAX_DISTANCE_MM_S_CACHE=500;
int16_t ACCELERATION_MAX_DISTANCE_MM_S2=1000,ACCELERATION_MAX_DISTANCE_MM_S2_CACHE=1000;
int16_t BRAKING_MAX_DISTANCE_MM_S2=400,BRAKING_MAX_DISTANCE_MM_S2_CACHE=400;
int16_t SPEED_MAX_ANGLE_MM_S=300,SPEED_MAX_ANGLE_MM_S_CACHE=300;
int16_t ACCELERATION_MAX_ANGLE_MM_S2=1000,ACCELERATION_MAX_ANGLE_MM_S2_CACHE=1000;
int16_t BRAKING_MAX_ANGLE_MM_S2=400,BRAKING_MAX_ANGLE_MM_S2_CACHE=400;
float ANTICIPATION_PERCENTAGE=0.1,ANTICIPATION_PERCENTAGE_CACHE=0.1;
float LOOP_CONTROL_TIMING_HZ=1000;

/* PID CONTROL*/
float P_DISTANCE=0,P_DISTANCE_CACHE=0;//2
float I_DISTANCE=0,I_DISTANCE_CACHE=0;
float D_DISTANCE=0,D_DISTANCE_CACHE=0;
float P_ANGLE=1,P_ANGLE_CACHE=1;
