...
int16_t ACCELERATION_MAX_DISTANCE_MM_S2=100,ACCELERATION_MAX_DISTANCE_MM_S2_CACHE=100;
int16_t BRAKING_MAX_DISTANCE_MM_S2=400,BRAKING_MAX_DISTANCE_MM_S2_CACHE=400;
int16_t SPEED_MAX_ANGLE_MM_S=250,SPEED_MAX_ANGLE_MM_S_CACHE=250;
int16_t ACCELERATION_MAX_ANGLE_MM_S2=400,ACCELERATION_MAX_ANGLE_MM_S2_CACHE=400;
int16_t BRAKING_MAX_ANGLE_MM_S2=2,BRAKING_MAX_ANGLE_MM_S2_CACHE=2;
float ANTICIPATION_PERCENTAGE=50,ANTICIPATION_PERCENTAGE_CACHE=50;
float LOOP_CONTROL_TIMING_HZ=1000;

/* PID CONTROL*/
float P_DISTANCE=20,P_DISTANCE_CACHE=20;//2
float I_DISTANCE=0,I_DISTANCE_CACHE=0;
float D_DISTANCE=-0.1,D_DISTANCE_CACHE=-0.1;
float P_ANGLE=4000,P_ANGLE_CACHE=4000;
float I_ANGLE=0,I_ANGLE_CACHE=0;
float D_ANGLE=-0.1,D_ANGLE_CACHE=-0.1;
#endif
