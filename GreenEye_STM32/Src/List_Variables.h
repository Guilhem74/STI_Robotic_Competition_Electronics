...
float TICS_2_MM=0,TICS_2_MM_CACHE=0;
float SPACING_WHEELS=1,SPACING_WHEELS_CACHE=1;
float FINAL_BOOL_DISTANCE_MM,FINAL_BOOL_DISTANCE_MM_CACHE=0;
...
int16_t BRAKING_MAX_DISTANCE_MM_S2=1,BRAKING_MAX_DISTANCE_MM_S2_CACHE=1;
...
float ANTICIPATION_PERCENTAGE=0,ANTICIPATION_PERCENTAGE_CACHE=0;
float LOOP_CONTROL_TIMING=1;

/* PID CONTROL*/
float P_DISTANCE=0,P_DISTANCE_CACHE=0;
